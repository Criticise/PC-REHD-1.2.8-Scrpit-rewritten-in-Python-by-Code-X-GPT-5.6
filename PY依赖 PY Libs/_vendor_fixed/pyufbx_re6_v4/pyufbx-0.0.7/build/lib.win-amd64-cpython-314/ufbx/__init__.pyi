...
class Mesh(Element):
    ...
    def get_vertex_uvs_for_set(self, index: int) -> np.ndarray[Any, Any] | None: ...
    def get_vertex_uv_indices_for_set(self, index: int) -> np.ndarray[Any, Any] | None: ...
